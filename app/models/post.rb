...
class Post < ApplicationRecord
  ...
  NON_KNOWN_ARTIST_TAGS = %w[unknown_director anonymous_director third-party_edit].freeze
  ...
  module ValidationMethods
    ...
    def has_enough_tags
      ...
      if tags.count {|t| t.category == Tag.categories.general} < 10
        self.warnings.add(:base, "Uploads must have at least 10 general tags. Read [[e6ai:tags]] for guidelines on tagging your uploads")
      end
    end
  end
