        ...
        if params[:commit] == "Delete"
          ...
          if params[:dmail].present?
            Dmail.create_automated({
              ...
              title: @post.substitute_deletion_dmail_template(params[:dmail_title]) || "Post ##{params[:id]} has been deleted",
              body: @post.substitute_deletion_dmail_template(params[:dmail], params[:reason].to_s),
            })
          end
        end
